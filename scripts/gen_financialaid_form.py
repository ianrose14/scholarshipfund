...
def create_application_form(output_path="financialaid.pdf"):
    ...
    # nrows = 20
    # textarea_height = nrows * 11 * 1.2  # 11pt font, 1.2 line spacing
    #
    # widget = pymupdf.Widget()
    # widget.rect = pymupdf.Rect(margin, ypos, xmax - margin, ypos + textarea_height)
    # widget.field_name = 'personal_stmt_field'
    # widget.field_type = pymupdf.PDF_WIDGET_TYPE_TEXT
    # widget.fill_color = (0.9, 0.9, 1)
    # widget.text_font = def_font
    # widget.text_fontsize = def_fontsize
    # widget.field_value = "\n" * (nrows - 1)  # pre-fill with blank lines
    # page.add_widget(widget)

    # 2. Define the rectangle for the text field
    # Rect(x0, y0, x1, y1)
    # rect = pymupdf.Rect(margin, 500, 400, 800)
    #
    # # 3. Create a widget object for the text field
    # multiline_field = pymupdf.Widget()
    # multiline_field.rect = rect
    # multiline_field.field_type = pymupdf.PDF_WIDGET_TYPE_TEXT  # Type 7
    # multiline_field.field_name = "multiline_text_field"
    # multiline_field.text_fontsize = 12
    #
    # # 4. Set the multiline flag
    # # Using the symbolic constant is more readable
    # multiline_field.field_flags = pymupdf.PDF_FIELD_IS_MULTILINE
    #
    # # You can also set initial text
    # multiline_field.field_value = "This is a multiline text field.\n\nYou can type and edit text in this box after opening it in a PDF viewer."
    #
    # # 5. Add the widget to the page
    # page.add_widget(multiline_field)
